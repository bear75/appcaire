...
The Support System provides comprehensive assistance and resources for users, following SaaS industry best practices while maintaining a focus on home care-specific needs.

#### 5.2.2 Core Components (MVP Priority)

##### A. Contact Information

- Direct support email and phone numbers
- Support hours and response time expectations
- Emergency contact procedures
- Office location and general inquiries

##### B. Basic Support Documentation

- Getting started guide
- Common troubleshooting steps
- Basic FAQ for core features
- Security and privacy guidelines

#### 5.2.3 Future Expansion Components (Post-MVP)
...
- Feature request/bug report forms
...
- Expanded FAQ and knowledge base
- Support ticket system
...
### 5.4 Employee & Client Management
...
- Scheduler
  - Can manage and optimize schedules
  - Can view employee and client data
...
- Ops Manager
  ...
  - Can view schedules
  - Can access operational analytics
- Support
...
- Suspended (payment/compliance issues)
- Expired (trial ended)
